        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {userId && (
              <Button
                variant="outline"
                onClick={() => window.open(`/store/${userId}`, "_blank")}
              >
                ...
                <CardContent className="pt-0">
                  ...
                  {product.cost_price != null && product.cost_price > 0 && (
                    <div className="flex items-center gap-2 mb-4 text-sm">
                      <span className="text-muted-foreground">Margem:</span>
                      <span className={`font-semibold ${
                        ((product.price - product.cost_price) / product.price) * 100 >= 30
                          ? 'text-green-600'
                          : 'text-orange-600'
                      }`}>
                  ...
                  <div className="border-t border-border/50 pt-4 mt-4">
                    <ProductOptionsManager productId={product.id} productName={product.name} />
                  </div>
                </CardContent>
              </Card>
            ))
